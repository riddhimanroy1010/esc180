...
def perform_activity(activity, duration):
    '''Running gives 3 hp/min for upto 180 uninterrupted min, then 1hp/min for
    every min after 180.

    Carrying textbooks = 2hp/min

    Resting = 0he/min

    running, carrying = -2he/min while tired and not star

    tired if last_activity != resting and last_activity_duration - cur_time < 120

    while not tired, running gives 2 he/min for first 10 min, then -2 for every
    min after 10. carrying gives one he/min for first 20, then -1 for every min
    after 20.
    '''
    global cur_hedons, cur_health
